...
def get_category_report(trained_model, test_data_loader, loss_fn, device, n_examples, epoch):
    ...
    write_path = "../../Results/Prediction/cca/category_experiment_chinese_" + str(epoch) + ".pickle"
